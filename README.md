...
Tech Stack
Frontend: TanStack Start (React) · Tailwind · Framer Motion AI: Groq (Llama 3.3 70B, automatic fallback to Llama 3.1 8B) Transcripts: youtube-transcript.io Deployment: Vercel
...
Try It
Paste any YouTube link at wistube-ai-v3-dev.vercel.app. No account required.
