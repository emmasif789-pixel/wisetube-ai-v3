...
export function ListenPanel({
  ...
  // Auto-scroll current sentence into view, centered.
  useEffect(() => {
  ...
  // Sticky mini-player appears once the main panel scrolls out of view.
  useEffect(() => {
  ...
  return (
    <>
      ...
      {/* Sticky mini-player, shown once the main panel scrolls out of view */}
      <AnimatePresence>
        {showMiniPlayer && (
          <motion.div
